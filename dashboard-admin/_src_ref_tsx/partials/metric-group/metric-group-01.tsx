...
const PartialsMetricGroupMetricGroup01: React.FC = () => {
  return <div dangerouslySetInnerHTML={{ __html: `<div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6">
  <!-- Metric Item Start -->
  <div
...
export default PartialsMetricGroupMetricGroup01;
