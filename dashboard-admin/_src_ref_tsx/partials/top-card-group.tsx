...
const PartialsTopCardGroup: React.FC = () => {
  return <div dangerouslySetInnerHTML={{ __html: `<div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
  <!-- Card item -->
  <div
...
export default PartialsTopCardGroup;
