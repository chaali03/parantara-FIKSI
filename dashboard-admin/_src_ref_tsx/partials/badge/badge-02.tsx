...
const PartialsBadgeBadge02: React.FC = () => {
  return <div dangerouslySetInnerHTML={{ __html: `<div class="flex flex-wrap gap-4 sm:items-center sm:justify-center">
  <!-- Primary Badge-->
  <span
...
export default PartialsBadgeBadge02;
